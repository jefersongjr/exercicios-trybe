...
console.log(`A área de um losango que tem D = 32cm e d = 18cm: ${Exercise.losangle(32, 18)}cm²`);
console.log(`A área de um losango que tem D = 200cm e d =50cm: ${Exercise.losangle(200, 50)}cm²`);
console.log(`A área de um losango que tem D = 75cm e d = 25c:: ${Exercise.losangle(75, 25)}cm²`);
